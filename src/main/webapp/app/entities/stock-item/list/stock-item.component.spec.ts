...
describe('StockItem Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'stock-item', component: StockItemComponent }]),
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.stockItems?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to stockItemService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getStockItemIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getStockItemIdentifier).toHaveBeenCalledWith(entity);
