...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, com.crepo.reports.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, com.crepo.reports.repository.UserRepository.USERS_BY_EMAIL_CACHE);
